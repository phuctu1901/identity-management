            ...
            <div class="card-block px-90 col-12">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <form id="citizen-info">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 input-group" style="z-index:0;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" data-type="date" id="dob" />
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
                        <div class="form-group d-flex justify-content-center qr-code-content">
                            <div id="qrcode" class="qrcode"></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3" id="logs-area">
